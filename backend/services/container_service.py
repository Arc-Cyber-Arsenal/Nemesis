...
class ContainerService:
                ...
                for line in result["stdout"].split('\n'):
                    if line.strip():
                        try:
                            ...
                            # Accept containers matching any configured prefix (nemesis-, exegol-, ...)
    ...
    async def _resolve_active_container(self, db: AsyncSession) -> str:
        ...
        which covers the Exegol mode where nemesis-pentest is not started.
        """
...
"""
    ...
    async def create_workspace(self, assessment_name: str, db: Session = None) -> Dict[str, str]:
        ...
        methodology_content = (
            "# Methodology Report\\n\\n"
            "> Generated by Nemesis AI at the end of the engagement.\\n"
