...
class WorkspaceService:
    ...
    async def get_container_workspace_mount(self, container_name: str) -> Optional[Dict[str, str]]:
        ...
        Returns:
            ...
            Example: {"host_path": "~/.exegol/workspaces/exegol-nemesis", "container_path": "/workspace"}
        """
    ...
    async def get_host_workspace_path(
        ...
        Example:
            container_path="/workspace/assessment-1", container_name="exegol-nemesis"
            → "~/.exegol/workspaces/exegol-nemesis/assessment-1"
