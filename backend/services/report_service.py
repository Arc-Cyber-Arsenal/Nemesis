...
def _load_logo_b64() -> str:
    """Load Nemesis logo as base64 data URI."""
    logo_candidates = [
        Path(__file__).resolve().parent.parent.parent / "frontend" / "public" / "assets" / "nemesis-logo.png",
        Path(__file__).resolve().parent.parent / "assets" / "nemesis-logo.png",
    ]
...
# ---------------------------------------------------------------------------
# Jinja2 HTML template — professional Nemesis pentest report
# ---------------------------------------------------------------------------
...
<style>
  ...
  @page {
    ...
    @bottom-left {
      content: "CONFIDENTIAL — Nemesis Security Report";
      font-size: 7pt;
      color: #94a3b8;
...
<div class="cover">
  <div class="cover-inner">
    {% if logo_b64 %}
    <img class="cover-logo" src="{{ logo_b64 }}" alt="Nemesis">
    {% endif %}
    <div class="cover-brand">Nemesis</div>
    ...
    <div class="cover-footer">This document is confidential and intended solely for the named recipient. Generated by Nemesis — AI-Driven Assessment.</div>
  </div>
</div>
...
<p class="text-muted" style="margin-bottom:10px">Sensitive values are masked in this report. Refer to the Nemesis platform for full credential data.</p>
