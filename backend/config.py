"""
Configuration for Nemesis - AI-Driven Security Assessment
"""
import os
...
class Settings(BaseSettings):
    ...
    POSTGRES_USER: str = "nemesis"
    POSTGRES_PASSWORD: str = "nemesis"
    POSTGRES_DB: str = "nemesis_assessments"
    ...
    DEFAULT_CONTAINER_NAME: str = "nemesis-pentest"
    # Comma-separated list of accepted container name prefixes.
    # Both nemesis- (new) and exegol- (legacy) are accepted for backward compat.
    CONTAINER_PREFIX_FILTER: str = "nemesis-,exegol-"
    ...
    # Authentication (JWT)
    SECRET_KEY: str = "nemesis-secret-key-change-in-production-min-32-chars!"
    ...
    def construct_database_url(cls, v: Optional[str], values) -> str:
        ...
        user = os.getenv("POSTGRES_USER", "nemesis")
        password = os.getenv("POSTGRES_PASSWORD", "nemesis")
        host = os.getenv("POSTGRES_HOST", "localhost")
        port = os.getenv("POSTGRES_PORT", "5432")
        db = os.getenv("POSTGRES_DB", "nemesis_assessments")
